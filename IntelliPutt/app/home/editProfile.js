        ...
        return (
            <View className="max-h-full ">
                ...
                <SafeAreaView className="bg-stone-100 flex flex-col space-y-2 items-center justify-start h-full">
                    ...
                    <View className="flex flex-col items-center mt-[50px] w-4/5 my-[50px]">
                        <Text className="fixed top-[75px] left-0 [font-family:'Poppins-Bold',Helvetica] font-bold text-lime-950 text-[32px] tracking-[0] leading-[normal]">
                            Edit your details
                        </Text>
                    </View>

                    <View className="w-4/5 flex flex-col pt-[45px]">
                        <TextField placeholder="Name" value={user.name} onChangeText={setName}/>
                        <TextField placeholder="Username" value={user.username} onChangeText={setUsername} />
                        <TextField placeholder="Email" value={user.email} onChangeText={setEmail} />
                        <TextField placeholder="Password" value={user.password} onChangeText={setPassword} />
                        ...
                        <View className="w-full h-20 flex flex-row justify-between mb-4 ">
                            ...
                            <View className="w-[65%] h-[100%]  flex flex-col justify-between">
                                <Text className="text-base mt-2 font-semibold text-stone-700">Select a profile picture</Text>
                                <Pressable onPress={pickImage} className="w-[100%] h-[50%] rounded-lg bg-brand-colordark-green flex flex-row items-center justify-center">
                                    <Text className="text-stone-50 font-semibold">Upload</Text>
                                </Pressable>
                            </View>
                        </View>
